...
int main(int argc, char *argv[])
{
    ...
    timerCombinedSaxpyLine16.Print("Total Combined Saxpy Time on Line 16: ");
    ...
    timerCombinedLine6.Print("Total Combined Line6 Time: ");
